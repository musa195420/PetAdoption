  ...
  module.exports = {
    ...
    updateBreed: async (req, res) => {
      try {
        ...
        res.status(200).json({ success:true,status: 200,  message: "Breed updated successfully", data: result });
      } catch (err) {
        res.status(500).json({ success:false,status: 400, message: err.message });
      }
    },
    ...
    deleteBreed: async (req, res) => {
      try {
        ...
        res.status(200).json({ success:true,status: 200,  message: "Breed deleted successfully", data: result });
      } catch (err) {
        res.status(500).json({ success:false,status: 400, message: err.message });
      }
    },
    ...
    bulkBreedInsert: async (req, res) => {
      try {
        ...
        res.status(200).json({ success:true,status: 200,  message: "Breeds inserted successfully", data: result });
      } catch (err) {
        res.status(500).json({ success:false,status: 400, message: err.message });
      }
    },
